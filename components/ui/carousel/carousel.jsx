...
const CarouselMainContainer = forwardRef(({ className, dir, children, ...props }, ref) => {
...
const CarouselThumbsContainer = forwardRef(({ className, dir, children, ...props }, ref) => {
...
const SliderThumbItem = forwardRef(({ className, index, children, ...props }, ref) => {
...
const CarouselIndicator = forwardRef(({ className, index, children, ...props }, ref) => {
...
const CarouselDescription = forwardRef(({ className, index, children, ...props }, ref) => {
